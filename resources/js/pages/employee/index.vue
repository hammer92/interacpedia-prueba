            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6 text-right">
                        <crear-employee @ok="getData" :lista-companies="listaCompanies"/>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
        </section>
                        ...
                        <ul class="pagination justify-content-start">
                            <li class="page-item" v-if="lista.current_page !== 1">
                                <a class="page-link" href="#" tabindex="-1" aria-disabled="true"
                                   @click.prevent="getData(lista.current_page-1)">{{ $t('previous') }}</a>
                            </li>
                            <li class="page-item"><p class="page-link"> {{lista.current_page}}/{{lista.last_page}}
                                Pag.</p></li>
                    ...
                    <div class="row d-flex align-items-stretch">
                        <div class="col-12" v-if="lista.data.length === 0">
                            <div class="error-page">
                                <h2 class="headline text-warning"><i
