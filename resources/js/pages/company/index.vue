            ...
            <div class="card card-solid">
                <div class="card-header">
                    <nav aria-label="Page navigation example">
                        <ul class="pagination justify-content-start">
                            <li class="page-item" v-if="lista.current_page !== 1">
                                <a class="page-link" href="#" tabindex="-1" aria-disabled="true" @click.prevent="getData(lista.current_page-1)">{{ $t('previous') }}</a>
                            </li>
                            <li class="page-item"> <p class="page-link"> {{lista.current_page}}/{{lista.last_page}} Pag.</p></li>
                            <li class="page-item"  v-if="lista.current_page !== lista.last_page">
                ...
                <div class="card-body pb-0">
                    <div class="row d-flex align-items-stretch">
                        <div class="col-12" v-if="lista.data.length === 0">
                        ...
                        <div class="col-12 col-sm-6 col-md-4 d-flex align-items-stretch" v-for="(item,index) in lista.data" :key="index">
                            <div class="card bg-light">
                                ...
                                <div class="card-body pt-0">
                                    <div class="row">
                                        <div class="col-7">
                                            <p class="lead text-sm"><b> {{ item.email }}</b></p>
                                            <p class="text-muted text-sm"><b>{{$t('website')}}: </b> {{item.website}}</p>
                                        </div>
